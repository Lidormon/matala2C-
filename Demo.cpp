...
int main()
{
    ...
    cout<<g1.printGraph()<<endl; // Should print the matrix of the graph: [0, 1, 0], [1, 0, 1], [0, 1, 0]
    ...
    cout<<g3.printGraph();           // Should print the matrix of the graph: [0, 2, 1], [2, 0, 3], [1, 3, 0]

    g1 *= -2;        // Multiply the graph by -2.
    cout<<g1.printGraph()<<endl; // Should print the matrix of the graph: [0, -2, 0], [-2, 0, -2], [0, -2, 0]
